...
\begin{figure}%[ht!]
    ...
    \end{tabular}
  \captionsetup{font=footnotesize}
    \caption{\label{fig:pasadizo3D}Mapa en tres dimensiones de un pasadizo. El mapa
    va rotando en sentido horario.}
\end{figure}
...
como prototipo de túnel dos cajas unidas, el cual se muestra en la Figura \ref{fig:exploracionMuqi}. 
...
\begin{figure}%[ht!]
    ...
    \begin{tabular}{cc}
      ...
      %\includegraphics[width=0.50\textwidth]{images/3DSotano4.png}\\
    \end{tabular}
  \captionsetup{font=footnotesize}
