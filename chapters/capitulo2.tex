...
\textit{Reiche Zeche} en Freiberg \cite{Grehl2015}. En el año 2014 se realizó la primera generación de modelos geométricos en tres
...
Para la construcción del mapa en dos dimensiones se utiliza el algoritmo SLAM, el cual es respaldado por trabajos anteriores. En Perú se desarrolló un robot móvil minero
