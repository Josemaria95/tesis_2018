...
En el año 2014 se realizó la primera generación de modelos geométricos en tres
...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[Robot móvil omnidireccional \cite{Omniwheel2018}.]{\label{fig:etiquetaB}\includegraphics[width=.40\textwidth]{images/omnidirecional.jpg}}
        \subfigure[Robot móvil diferencial \cite{NoHolonomic2018}.]{\label{fig:etiquetaC}\includegraphics[width=.50\textwidth]{images/RM_noHolonomic.jpg}}
    \end{center}
  \captionsetup{font=footnotesize}
    \caption{\label{f:sLocomocion}Sistemas holonómicos.}
\end{figure}
%\begin{figure}%[ht!]
...
en dos: (1) robot holonómico y (2) robot no-holonómico. El robot holonómico 
...
define las velocidades lineales y angulares para lograr la posición y orientación deseada es 
\begin{align}
\label{eqn:v}
v &= k_{\rho}\rho \\
\label{eqn:w}
...
A partir de la Figura \ref{f:mapPolygonal} se considera la inclusión de 
...
El algoritmo comienza con muestrear valores aleatorios para el robot 
...
en tres tipos diferentes: (1) un obst\'aculo (probabilidad de ocupaci\'on 
por encima de un umbral), (2) limpio (probabilidad de ocupaci\'on nulo) y 
(3) desconocido (nunca se detectó nada). De esta forma se empieza a 
...
b\'asicos los cuales son: (1) percepci\'on, el robot debe extraer e interpretar 
los datos de sus sensores para estimar su entorno; (2) localizaci\'on, el robot 
debe determinar su posici\'on en el entorno; (3) cognici\'on, el robot debe tener 
la capacidad de decidir c\'omo actuar para lograr su objetivo; y (4) control de 
