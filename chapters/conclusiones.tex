...
el sensor lidar, un motor paso a paso y la odometría del robot móvil. Esto se aplicó para el mapeo
tridimensional en una caja, dentro de un sótano y el pasadizo dentro de un edificio. Se
...
explorar dentro de un ambiente desconocido. Se demuestra que el sistema mecánico construido genera mapas tridimensionales con errores menor a los 5 cm.
}
