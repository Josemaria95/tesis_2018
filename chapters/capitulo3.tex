...
\begin{figure}%[ht!]
	...
	\\ a. Sistemas de referencia del sistema mecánico ~~~ b. Rotación y Translación 
	del S.M.
	\captionsetup{font=footnotesize}
...
figura \ref{f:Rot3D} a. La representación de la posición y orientación de la nube de puntos es representada
como:
\begin{align}
	\tilde{p}^{M} = T_{L}^{M} \tilde{p}^{L}
	\label{eqn:MatrizHomogenea}
...
\begin{figure}%[ht!]
	\centering \footnotesize
	\includegraphics[width=1.1\textwidth]{images/estruct_auto.png}
	\captionsetup{font=footnotesize}
