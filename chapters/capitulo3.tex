...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[Sistema mecánico]{\label{fig:etiquetaB}\includegraphics
        [width=.45\textwidth]{images/lidar_3d.png}}
        \subfigure[Sistema mecánico sobre el Kobuki]{\label{fig:etiquetaC}\includegraphics
        [width=.45\textwidth]{images/lidar_wKbki.png}}
    \end{center}
  \captionsetup{font=footnotesize}
...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[Sistemas de referencia]{\label{fig:etiquetaB}\includegraphics[width=.47\textwidth]{images/lidar_ref.png}}
        \subfigure[Rotación y traslación]{\label{fig:etiquetaC}\includegraphics[width=.50\textwidth]{images/lidar_giro.png}}
    \end{center}
  \captionsetup{font=footnotesize}
...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[Fuerzas de atracción]{\label{fig:etiquetaB}\includegraphics[width=.49\textwidth]{images/attr_force.png}}
        \subfigure[Fuerzas de repulsión]{\label{fig:etiquetaC}\includegraphics[width=.49\textwidth]{images/rep_force.png}}
        \subfigure[Fuerzas de navegación]{\label{fig:etiquetaC}\includegraphics[width=.49\textwidth]{images/nav_force.png}}
    \end{center}
  \captionsetup{font=footnotesize}
