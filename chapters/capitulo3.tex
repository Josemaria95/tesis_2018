...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[Sistema mecánico]{\label{fig:etiquetaB}\includegraphics[width=.45\textwidth]{images/lidar_3d.png}}
        \subfigure[Sistema mecánico sobre el Kobuki]{\label{fig:etiquetaC}\includegraphics[width=.45\textwidth]{images/lidar_wKbki.png}}
    \end{center}
  \captionsetup{font=footnotesize}
